...
void Viewport::lookAndFeelChanged()
{
	...
	if( verticalScrollBar != nullptr )
	{
		...
		removeChildComponent( verticalScrollBar );
	}
	
	if( horizontalScrollBar != nullptr )
	{
		horizontalScrollBar->removeListener( this );
		removeChildComponent( horizontalScrollBar );
	}
	
	LookAndFeel& lf = getLookAndFeel();
	verticalScrollBar = lf.createScrollBar(true);
	horizontalScrollBar = lf.createScrollBar(false);
