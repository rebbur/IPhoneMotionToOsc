...
public:
    ...
    */
    ScrollBar* getVerticalScrollBar() noexcept                  { return verticalScrollBar; } // MODIFIED_BY_RESOLUME

    /** Returns a pointer to the scrollbar component being used.
        Handy if you need to customise the bar somehow.
    */
    ScrollBar* getHorizontalScrollBar() noexcept                { return horizontalScrollBar; } // MODIFIED_BY_RESOLUME
