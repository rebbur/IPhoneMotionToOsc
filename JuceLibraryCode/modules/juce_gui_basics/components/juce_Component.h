...
public:
    ...
    */
	...
	//Jules decided to remove this function. I've readded it again because it's actually being used by us.
    JUCE_DEPRECATED ( void getVisibleArea (RectangleList<int>& result, bool includeSiblings) const );
