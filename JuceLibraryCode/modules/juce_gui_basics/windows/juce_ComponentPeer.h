...
public:
    ...
    */
    ...
    virtual void setIgnoreWindowConstrains(bool ignore) { ignoreWindowConstrains = ignore; }
	bool getIgnoreWindowConstrains() { return ignoreWindowConstrains; }
