...
public:
    ...
    */
	...
	//BEGIN_MODIFIED_BY_RESOLUME
	void setNumDisplayDecimalPlaces(int newValue);
	void setDisplayTrailingZeroes(bool displayTrailingZeroes = true);
	void setTextBoxOffset(const int x, const int y);
	virtual String getFullTextFromValue(double v);
	void setWrapsRange(bool wraps);
	bool getWrapsRange() const;
	virtual bool getButtonIncrement(double & delta, bool incButtonPressed){ return false; }
	//END_MODIFIED_BY_RESOLUME
    ...
    */
    struct JUCE_API  LookAndFeelMethods
    {
		...
		virtual NumericLabel* createSliderTextBox (Slider&) = 0;
		//END_MODIFIED_BY_RESOLUME
