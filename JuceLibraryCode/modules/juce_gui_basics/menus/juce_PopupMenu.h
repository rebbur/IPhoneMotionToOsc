...
public:
    ...
    */
    ...
    //BEGIN_MODIFED_BY_RESOLUME
	static bool JUCE_CALLTYPE isCurrentlyAMenuActive(); // Returns true if there is currently is a menu opened
    //END_MODIFED_BY_RESOLUME
    ...
    */
    ...
    public:
        ...
        */
		...
		//BEGIN_MODIFED_BY_RESOLUME
		virtual void menuItemHighlighted() {};
		//END_MODIFED_BY_RESOLUME
