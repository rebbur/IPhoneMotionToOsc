...
class LookAndFeel_V2::SliderLabelComp  : public NumericLabel // public Label
{
public:
    SliderLabelComp() : NumericLabel (String(), String()) {}

    void mouseWheelMove (const MouseEvent&, const MouseWheelDetails&) {}
};

//Label* LookAndFeel_V2::createSliderTextBox (Slider& slider)
NumericLabel* LookAndFeel_V2::createSliderTextBox (Slider& slider)
{
    //Label* const l = new SliderLabelComp();
	NumericLabel* const l = new SliderLabelComp();
...
// BEGIN_MODIFIED_BY_RESOLUME
ScrollBar* LookAndFeel_V2::createScrollBar(bool vertical)
{
